...
pub use queries::{
    ...
    latest_detection, latest_detection_full, list_analysis_runs, list_image_blacklist,
    list_quarantine, lock_detection, locked_file_names, low_confidence_species,
    model_vs_review_by_species, prune_quarantine, prune_species_clips, quality_summary,
