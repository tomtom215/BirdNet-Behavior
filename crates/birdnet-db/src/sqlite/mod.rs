...
pub use queries::{
    ...
    list_quarantine, lock_detection, locked_file_names, low_confidence_species, prune_quarantine,
    quality_summary, quarantine_pending_count, quarantine_stats, range_daily_counts,
    recent_by_species, recent_detections, recent_detections_page, reject_quarantine,
    relabel_detection, remove_image_blacklist, search_species, set_species_threshold,
