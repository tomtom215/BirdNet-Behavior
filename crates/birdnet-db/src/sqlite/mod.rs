...
pub use queries::{
    ...
    SortOrder, SpeciesThreshold, TodayFilter, VerdictFilter, add_image_blacklist,
    ...
    detected_at_utc_for, detection_at, detection_count, detection_count_for_date,
    detection_count_for_species_date, detection_dates, detection_quality_by_hour,
    detections_by_date, detections_by_species, detections_per_day, distinct_detection_dates,
    get_quarantine, get_species_threshold_map, get_species_thresholds, hourly_activity,
    hourly_totals, insert_detection, insert_quarantine, is_detection_locked, is_image_blacklisted,
    known_sources, last_hour_count, latest_detection, latest_detection_full, list_image_blacklist,
    ...
    remove_image_blacklist, review_verdict_trend, reviewed_detections_by_species,
