...
pub use detections::{
    CLIP_AVAILABLE, DateRange, DetectionFilter, HourWindow, LockFilter, RecordingsFilter,
    SortOrder, TodayFilter, VerdictFilter, all_detections, analytic_detection_count,
    analytic_detection_count_for_date, analytic_detections_above, analytic_species_count_for_date,
    best_detections_for_date, com_name_for, concurrent_detections_from_other_sources,
    delete_detection, detected_at_utc_for, detection_at, detection_count, detection_count_for_date,
    detection_count_for_species_date, detection_dates, detections_by_date, detections_by_species,
    detections_per_day, insert_detection, is_detection_locked, known_sources, lock_detection,
    locked_file_names, recent_clips, recent_clips_count, recent_detections, recent_detections_page,
    relabel_detection, search_detection_count, search_detections, seconds_since_last_detection,
