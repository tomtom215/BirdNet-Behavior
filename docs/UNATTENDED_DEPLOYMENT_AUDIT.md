...
| **OP-13** | P2 | VERIFIED | The model is checked as a file, not as a model. Same as **ON-9**. | A session load and an output-width assertion. **[FIXED]** (`HASH`, 2026-09-08) with **ON-9**. |
