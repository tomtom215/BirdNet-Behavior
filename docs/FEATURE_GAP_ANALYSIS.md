...
#### G‑10 · Multiple classifier models — IN PROGRESS (Stages 1–4; Stage 4 partial, with the reason)
...
| # | Item | Finding | Shape |
|---|---|---|---|
| 26 | Multi-model classifier stack | G‑10 | **Stages 1–3 shipped; Stage 4 partial.** Perch v2 exposed two defects (class head by position, sample rate derived not declared), both fixed against the real model. Running two classifiers with different windows awaits a decision on what agreement means across differing time spans. Stages 5–6 follow |
