...
| **Plan (what remains)** | Export/import for metric rules, alongside the detection rules' existing `/admin/rules/export`. That is where `EXPORT_VERSION` would bump. |
...
| # | Item | Finding |
|---|---|---|
| 11 | ~~Metric-triggered alert rules~~ — **shipped**, see G‑29; export/import for them remains | G‑29 |
